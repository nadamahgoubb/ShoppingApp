...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // val curvedBottomNavigationView: CurvedBottomNavigationView = binding.curveBottomNavigationView

//        curvedBottomNavigationView.setupWithNavController(navHostFragment.findNavController())
